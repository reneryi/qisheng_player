...
bool FlutterWindow::OnCreate() {
  ...
  // Do not call this->Show() here to avoid exposing default 1280x720 window.
  // Dart's windowManager.waitUntilReadyToShow will handle showing the window
  // cleanly once dimensions, transparency and styles are applied.
  //
